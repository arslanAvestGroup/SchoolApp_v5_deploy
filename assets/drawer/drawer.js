...
// console.log(' drawerElem ', drawerElem);
...
function openDrawer(s) {
    ...
    document.documentElement.classList.add('drawer_open');
...
function closeDrawer(s) {
    ...
    document.documentElement.classList.remove('drawer_open');
}
...
(function () {
  //  console.log(' ################# drawer init1111  ');
    ...
    // var drawer_overlay = '<div class="drawer_overlay"></div>';
    // const drawer_overlay = document.createElement("DIV");
    // drawer_overlay.className = "drawer_overlay";
    // drawer_overlay.style.display = 'none';
    // document.body.appendChild(drawer_overlay);

    // add drawer close script on clicking drawer menu item.
    // console.log(' ################# drawer init  ');
    if( document.querySelectorAll("#drawer .content .menu li").length > 0 ){
      // console.log(' ################# drawer init  ', document.querySelectorAll("#drawer .content .menu li").length);
      document.querySelectorAll("#drawer .content .menu li").forEach(function(elem) {
